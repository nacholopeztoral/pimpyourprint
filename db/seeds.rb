...
user_t1 = Transportation.new(user_id: user.id, carbon: 53)
user_t1.created_at = 1.day.ago
user_t1.save
user_t2 = Transportation.new(user_id: user.id, carbon: 12)
user_t2.created_at = 2.days.ago
user_t2.save
user_t3 = Transportation.new(user_id: user.id, carbon: 99)
user_t3.created_at = 3.days.ago
user_t3.save
user_t4 = Transportation.new(user_id: user.id, carbon: 163)
user_t4.created_at = 4.days.ago
user_t4.save
user_t5 = Transportation.new(user_id: user.id, carbon: 12)
