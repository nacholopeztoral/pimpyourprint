class MyChallengesController < ApplicationController
  ...
  def show
    ...
    redirect_to dashboard_path flash[:alert] = "Unfortunately, we don't have anymore available challenges for you! How about you suggest a new one? #{ raw view_context.link_to('Suggest new challenge', new_challenge_path)}".html_safe if @challenge.nil?
